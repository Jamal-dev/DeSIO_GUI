...
set path_mtee=DeSiO
REM
set path_fsi=/home/jamal/qt_project_learning/DeSIO_GUI/yaml_and_converter/15MW_pitch5_vel10_nspan40_test/DeSiO
set path_struc=/home/jamal/qt_project_learning/DeSIO_GUI/yaml_and_converter/15MW_pitch5_vel10_nspan40_test/DeSiO-Structure
