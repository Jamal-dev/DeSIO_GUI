...
% =================================================================================================================
    ...
    strfilename = [strfilename '_' 'pitch' num2str(model.environment.pitch_angle) '_vel' num2str(model.environment.vinf) '_nspan' num2str(model.components.blade.DeSiO.uvlm.M_aero)];
